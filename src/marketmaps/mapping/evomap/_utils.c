...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "C:\\Users\\MPMATTHE\\Anaconda3\\lib\\site-packages\\numpy\\core\\include\\numpy\\arrayobject.h",
            "C:\\Users\\MPMATTHE\\Anaconda3\\lib\\site-packages\\numpy\\core\\include\\numpy\\npy_math.h",
            "C:\\Users\\MPMATTHE\\Anaconda3\\lib\\site-packages\\numpy\\core\\include\\numpy\\ufuncobject.h"
        ],
        "include_dirs": [
 ...
 */
          ...
          } else if (unlikely(__pyx_t_23 >= __pyx_pybuffernd_P.diminfo[0].shape)) __pyx_t_20 = 0;
          if (__pyx_t_24 < 0) {
            __pyx_t_24 += __pyx_pybuffernd_P.diminfo[1].shape;
            if (unlikely(__pyx_t_24 < 0)) __pyx_t_20 = 1;
          } else if (unlikely(__pyx_t_24 >= __pyx_pybuffernd_P.diminfo[1].shape)) __pyx_t_20 = 1;
          if (unlikely(__pyx_t_20 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_20);
 ...
 */
        ...
        } else if (unlikely(__pyx_t_25 >= __pyx_pybuffernd_P.diminfo[0].shape)) __pyx_t_20 = 0;
        if (__pyx_t_26 < 0) {
          __pyx_t_26 += __pyx_pybuffernd_P.diminfo[1].shape;
          if (unlikely(__pyx_t_26 < 0)) __pyx_t_20 = 1;
        } else if (unlikely(__pyx_t_26 >= __pyx_pybuffernd_P.diminfo[1].shape)) __pyx_t_20 = 1;
        if (unlikely(__pyx_t_20 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_20);
 ...
 */
        ...
        __pyx_t_20 = -1;
        if (__pyx_t_27 < 0) {
          __pyx_t_27 += __pyx_pybuffernd_sqdistances.diminfo[0].shape;
          if (unlikely(__pyx_t_27 < 0)) __pyx_t_20 = 0;
        } else if (unlikely(__pyx_t_27 >= __pyx_pybuffernd_sqdistances.diminfo[0].shape)) __pyx_t_20 = 0;
        if (__pyx_t_28 < 0) {
          __pyx_t_28 += __pyx_pybuffernd_sqdistances.diminfo[1].shape;
          if (unlikely(__pyx_t_28 < 0)) __pyx_t_20 = 1;
        } else if (unlikely(__pyx_t_28 >= __pyx_pybuffernd_sqdistances.diminfo[1].shape)) __pyx_t_20 = 1;
        if (unlikely(__pyx_t_20 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_20);
        ...
        } else if (unlikely(__pyx_t_29 >= __pyx_pybuffernd_P.diminfo[0].shape)) __pyx_t_20 = 0;
        if (__pyx_t_30 < 0) {
          __pyx_t_30 += __pyx_pybuffernd_P.diminfo[1].shape;
          if (unlikely(__pyx_t_30 < 0)) __pyx_t_20 = 1;
        } else if (unlikely(__pyx_t_30 >= __pyx_pybuffernd_P.diminfo[1].shape)) __pyx_t_20 = 1;
        if (unlikely(__pyx_t_20 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_20);
          __PYX_ERR(0, 88, __pyx_L1_error)
        }
        __pyx_v_sum_disti_Pi = (__pyx_v_sum_disti_Pi + ((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_sqdistances.rcbuffer->pybuffer.buf, __pyx_t_27, __pyx_pybuffernd_sqdistances.diminfo[0].strides, __pyx_t_28, __pyx_pybuffernd_sqdistances.diminfo[1].strides)) * (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_P.rcbuffer->pybuffer.buf, __pyx_t_29, __pyx_pybuffernd_P.diminfo[0].strides, __pyx_t_30, __pyx_pybuffernd_P.diminfo[1].strides))));
      }
 ...
 *     if verbose:
 */
      __pyx_t_5 = __Pyx_PyInt_From_long((__pyx_v_i + 1)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 113, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_4 = __Pyx_PyInt_From_long(__pyx_v_n_samples); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 113, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      ...
      __pyx_t_5 = 0;
      __pyx_t_4 = 0;
      __pyx_t_4 = __Pyx_PyString_Format(__pyx_kp_s_t_SNE_Computed_conditional_prob, __pyx_t_3); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 113, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_mean); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 117, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    ...
    __pyx_t_3 = PyFloat_FromDouble(sqrt((__pyx_v_n_samples / __pyx_v_beta_sum))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 117, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_2 = NULL;
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyString_FormatSafe(__pyx_kp_s_t_SNE_Mean_sigma_f, __pyx_t_4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 117, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
static PyObject *__pyx_pf_6_utils__binary_search_perplexity(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_sqdistances, float __pyx_v_desired_perplexity, int __pyx_v_verbose) {
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_6_utils__binary_search_perplexity(__pyx_v_sqdistances, __pyx_v_desired_perplexity, __pyx_v_verbose, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
